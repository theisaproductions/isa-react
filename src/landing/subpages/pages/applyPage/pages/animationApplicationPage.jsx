        ...
        <div className=''>
            ...
            <div className='max-w-5xl mx-auto px-4 pt-28 pb-14 flex flex-col gap-14 md:gap-20 min-h-screen'>
                ...
                <div className='flex flex-col gap-6 items-center text-center justify-center'>
                    ...
                    <a target="_blank" rel="noreferrer" href="https://forms.gle/itKdXNdE7NNAkvsD6" className="bg-black/90 px-10 py-6 subheading text-green-400 hover:drop-shadow-dark1 duration-300">Click here to apply</a>
                </div>
