...
const PrimaryBlogThumb = ({data}) => {
    ...
    if(!data) {
        ...
        <Link to={`/blogs/${data.uid}`} className='grid grid-cols-1 md:grid-cols-3 gap-6 cursor-pointer'>
            <div className='relative rounded-md' style={{paddingTop: '56%'}}>
            ...
            <div className='space-y-2 md:col-span-2'>
                ...
                <h2 className='text-3xl md:text-4xl font-semibold leading-1 pb-6'>{data.data.article_blog_title[0].text}</h2>
                <p className='text-base text-gray-500 text-clip' style={ellipsisStyle}>{data.data.article_short_description[0].text}</p>
...
export default PrimaryBlogThumb;